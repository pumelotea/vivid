	...
	<div>
		<n-space :size="2">
			...
			<vivid-menu-item
				title="小型尺寸"
				:action="
					() => editorInstance.chain().focus().updateImage({ width: 200 }).run()
				"
			...
			<vivid-menu-item
				title="中型尺寸"
				:action="
					() => editorInstance.chain().focus().updateImage({ width: 500 }).run()
				"
			...
			<vivid-menu-item
				...
				:action="
					() =>
						editorInstance.chain().focus().updateImage({ width: '100%' }).run()
				"
