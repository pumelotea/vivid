...
import VividTableCreator from '../../core/components/VividTableCreator.vue'
...
import VividMathModal from '../../core/extension/math/VividMathModal.vue'
import {ref} from 'vue'
...
<template>
	<div class="menu-bar">
		...
		/>
		<!--    <vivid-menu-item icon="sip-line" title="单元格背景色"-->
